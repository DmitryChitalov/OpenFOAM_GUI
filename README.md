...
Предусматривает работу с утилитой cartesianMesh (для трехмерных сеток, состоящих прежде всего из шестигранников ) и файлом-словарем meshDict (для настройки параметров),
